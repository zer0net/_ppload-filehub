			...
			'<div class="pull-left col-xs-5">' + 
				...
				'<div class="site-title" ng-show="chJson">' + 
					...
					'<div class="sub-title">' + 
						...
						'<span ng-repeat="type in media_types"> &nbsp; • &nbsp; Files &nbsp;  {{optionalFileList.length}} / {{chJson[type].length}} &nbsp;• &nbsp; Size : &nbsp;{{settings.optional_downloaded|filesize}} / {{settings.size_optional|filesize}} Total</span>' +
						'</small>' + 
					'</div>' + 
				'</div>' + 
			'</div>' + 
